...
//receive function document.....
void students_cgpa(float students_cgpa){
    printf("cgpa =%f\n",students_cgpa);
...
void main()
{
    ...
    for(student=0;student<10;student++){
        ...
        fprintf(outfile,"%s",students[student].students_name);
    ...
    for(student=0;student<10;student++){
       ...
       students_cgpa(students[student].students_cgpa);
    }
    //find maximum grade .....
